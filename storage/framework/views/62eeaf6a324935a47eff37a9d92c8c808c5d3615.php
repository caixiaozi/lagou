        ...
        <div class="mws-panel-body no-padding">
            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    <?php $__currentLoopData = $vip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vvip): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr class="odd">
                            <td class="  sorting_1"><?php echo e($vvip->id); ?></td>
                            <td><?php echo e($vvip->avatar); ?></td>
                            <td><?php echo e($vvip->name); ?></td>
                            <td><?php echo e($vvip->email); ?></td>
                            <td> <?php echo e(str_replace([-1,0,1,2],['禁用','未激活','激活','后台添加'],$vvip->status)); ?></td>
                            <td><?php echo e($vvip->password); ?></td>
                            <td><?php echo e($vvip->created_at); ?></td>
                            <td><?php echo e($vvip->updated_at); ?></td>
                            <td>
                                 <a class = 'rules' data= '30' href="<?php echo e(url('admin/vip-update'.'/'.$vvip->id)); ?>" style="color:blue;"><i class="icon-wrench"></i>修改</a>
                                <br> <a class = 'rules' data= '31' href="<?php echo e(url('admin/vip-delete'.'/'.$vvip->id)); ?>" style="color:RED;"><i class="icon-trash"></i>删除</a>
                            </td>
                        </tr>
