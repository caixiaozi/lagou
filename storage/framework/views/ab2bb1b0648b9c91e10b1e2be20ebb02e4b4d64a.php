...
<head>
    ...
    <link href="<?php echo e(url('home/firm/css/style.css')); ?>" type="text/css" rel="stylesheet">
    <link href="<?php echo e(url('home/firm/css/extern/al.css')); ?>" type="text/css" rel="stylesheet">
    <link href="<?php echo e(url('home/firm/css/popup.css')); ?>" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="<?php echo e(url('home/firm/js/jquery.js')); ?>">
    </script>
    <script src="<?php echo e(url('home/firm/js/jquery_002.js')); ?>" type="text/javascript">
    </script>
    <script type="text/javascript" src="<?php echo e(url('home/firm/js/ajaxfileupload.js')); ?>">
    </script>
    <script src="<?php echo e(url('home/firm/js/additional-methods.js')); ?>" type="text/javascript">
    </script>

    <link rel="stylesheet" href="<?php echo e(url('home/firm/css/ui.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('home/firm/css/window.css')); ?>">
    <style type="text/css">a{text-decoration:none;}</style>
</head>

<body>
<div id="body">
    <link href="<?php echo e(url('home/firm/css/header.css')); ?>" rel="stylesheet">
    <!-- 未登录用户头部 -->
    <!-- 企业用户头部 -->
    <div id="lg_tbar">
        <div class="inner">
    ...
    <div id="container">
        ...
        <script src="<?php echo e(url('home/firm/js/jobs.js')); ?>" type="text/javascript">
        </script>
        <div class="clear">
        </div>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(url('home/firm/css/widgets_fec497b.css')); ?>">
<div id="footer">
    <div class="wrapper">
...
<script src="<?php echo e(url('home/firm/js/core.js')); ?>" type="text/javascript">
</script>
<script src="<?php echo e(url('home/firm/js/popup.js')); ?>" type="text/javascript">
</script>
