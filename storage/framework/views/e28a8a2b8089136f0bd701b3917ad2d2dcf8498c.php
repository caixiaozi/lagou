...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('home/shou/login/main.html_aio_67593ba.css')); ?>">
...
<section class="content_box cleafix">
    ...
    <div class="left_area fl">
        <form action="<?php echo e(url('home/doLogin')); ?>" method="post" id="forup">
            <div class="form_body"  data-view="loginView">
                ...
                <div class="input_item clearfix">
                    <a rel="nofollow" href="<?php echo e(url('retrievepassword')); ?>" class="forgot_pwd">忘记密码？</a>
                </div>
                ...
                <div class="input_item clearfix">
                    <h5 class="reg_now">还没有拉勾帐号？<a rel="nofollow" href="<?php echo e(url('/register')); ?>" data-lg-tj-id="1ja0" data-lg-tj-no="idnull" data-lg-tj-cid="idnull">立即注册</a></h5>
                </div>
...
<script type="text/javascript" src="<?php echo e(url('home/shou/login/vendor_c7a7c93.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('home/shou/login/main.html_aio_e995440.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('home/shou/login/static_ab40326.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(url('home/shou/login/oss.js')); ?>"></script>
</body>
</html>