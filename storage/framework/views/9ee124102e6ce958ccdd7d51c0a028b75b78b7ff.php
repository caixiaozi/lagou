...
<!DOCTYPE HTML>
<html lang="en"><head>
    <script type="text/javascript" async="" src="<?php echo e(url('home/jianli/js/conversion.js')); ?>"></script>
    <script src="<?php echo e(url('home/jianli/js/allmobilize.min.js')); ?>" charset="utf-8" id="allmobilize"></script>
    ...
    <link href="<?php echo e(url('home/jianli/css/style.css')); ?>" type="text/css" rel="stylesheet">
    <link href="<?php echo e(url('home/jianli/css/external.min.css')); ?>" type="text/css" rel="stylesheet">
    <link href="<?php echo e(url('home/jianli/css/popup.css')); ?>" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="<?php echo e(url('home/jianli/js/jquery.1.10.1.min.js')); ?>"></script>
    <script src="<?php echo e(url('home/jianli/js/jquery.lib.min.js')); ?>" type="text/javascript"></script>
    <script type="text/javascript" src="<?php echo e(url('home/jianli/js/ajaxfileupload.js')); ?>"></script>
    <script src="<?php echo e(url('home/jianli/js/additional-methods.js')); ?>" type="text/javascript"></script>
    <!--[if lte IE 8]>
    <script type="text/javascript" src="<?php echo e(url('home/jianli/js/excanvas.js')); ?>"></script>
    <![endif]-->
    <script type="text/javascript">
        var youdao_conv_id = 271546;
    </script>
    <script src="<?php echo e(url('home/jianli/js/conv.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(url('home/jianli/js/ajaxCross.json')); ?>" charset="UTF-8"></script></head>
    ...
    <div class="clearfix">
        <div class="content_l">
            <div class="fl" id="resume_name">
                <div class="nameShow fl">
                    <h1 ><?php echo e(session('vip') -> name); ?>的简历</h1>
                </div>
                <form class="fl dn" id="resumeNameForm">
                    <input type="text" value="<?php echo e(session('vip') -> name); ?>的简历" name="resumeName" class="nameEdit c9">
                </form>
            </div>
            ...
            <div class="profile_box" id="basicInfo">
                ...
                <div class="basicShow">
                    ...
                    <div class="m_portrait">
                        <div></div>
                        <img width="120" height="120" alt="jason" src="<?php echo e(url('home/jianli/images/default_headpic.png')); ?>">
                    </div>
                </div>

                <div class="basicEdit dn">
                    <form   action="<?php echo e(url('myresume/userupdate')); ?>" method="post">
        ...
        <!-- 期望工作 开始-->
            <div class="profile_box" id="expectJob">
                ...
                <div class="expectShow  <?php echo e(session('hope_out')); ?>">
                    <span></span>
                </div>
                <div class="expectEdit dn">
                    <form  action="<?php echo e(url('myresume/resumeshow')); ?>" method="post" >
                        <?php echo e(csrf_field()); ?>
        ...
        <!-- 工作经历 开始-->
            <div class="profile_box" id="workExperience">
                ...
                <div class="experienceEdit dn">
                    <form action="<?php echo e(url('myresume/hisajax')); ?>" method="post">
                        <?php echo e(csrf_field()); ?>
        ...
        <!-- 项目经验 开始-->
            <div class="profile_box" id="projectExperience">
                ...
                <div class="projectEdit dn">
                    <form action="<?php echo e(url('myresume/project')); ?>" method="post" >
                        <?php echo e(csrf_field()); ?>
        ...
        <!--教育背景 开始-->
            <div class="profile_box" id="educationalBackground">
                ...
                <div class="educationalEdit borderBtm dn" >
                    <form  action="<?php echo e(url('myresume/edu')); ?>" method="post">
                        <?php echo e(csrf_field()); ?>
        ...
        <!--自我描述 开始-->
            <div class="profile_box" id="selfDescription">
                ...
                <div class="descriptionEdit dn">
                    <form  action="<?php echo e(url('myresume/intro')); ?>" method="post" >
                        <?php echo e(csrf_field()); ?>
        ...
        <!--作品展示 开始-->
            <div class="profile_box" id="worksShow">
                ...
                <div class="workEdit dn">
                    <form  action="<?php echo e(url('myresume/works')); ?>" method="post" >
                        <?php echo e(csrf_field()); ?>
