...
<?php $__env->startSection('content'); ?>
    <div class="mws-panel grid_8">
        <div class="mws-panel-header">
            <span><i class="icon-user"></i> 角色管理</span>
        </div>
            ...
            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 75px;" aria-label="CSS grade: activate to sort column ascending">角色权限</th>
                    ...
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr class="odd">
                            <td class="  sorting_1"><?php echo e($role->id); ?></td>
                            <td class=" "><?php echo e($role->name); ?></td>
                            <td class=" "><?php echo e($role->display_name); ?></td>
                            <td class=" "><?php echo e($role->description); ?></td>
                            <td><?php echo e($role->perms); ?></td>
                            <td class=" ">
                                <a class = 'rules' data= '30' href="<?php echo e(url('admin/attach-permission'.'/'.$role->id)); ?>" style="color:blue;">分配权限</a>
                                <br>
                                <a class = 'rules' data= '30' href="<?php echo e(url('admin/role-update'.'/'.$role->id)); ?>" style="color:blue;"><i class="icon-wrench"></i>修改</a>
                                <br>
                                <a class = 'rules' data= '31' href="<?php echo e(url('admin/role-delete'.'/'.$role->id)); ?>" style="color:RED;"><i class="icon-trash"></i>删除</a>
                            </td>
