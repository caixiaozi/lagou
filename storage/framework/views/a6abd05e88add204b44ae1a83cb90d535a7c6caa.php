                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    <tr role="row">
                        <th   class="sorting_asc" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 10px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" >
                            id</th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 80px;" aria-label="Browser: activate to sort column ascending">网站名称</th>

                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 25px;" aria-label="Engine version: activate to sort column ascending"> URL</th>
                    ...
                    <?php $__currentLoopData = $res; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr class="odd">
                            ...
                            <td class=" "><?php echo e(date('Y-m-d  H:i:s',$v->create_time)); ?></td>

                            <td class=" "><?php echo e(str_replace([-1,0,1],['已下架','申请中','前台显示'],$v->state)); ?></td>
                            <td class=" ">
                                <a class = 'rules' data= '30' href="<?php echo e(url('/admin/links/edit'.'/'.$v->id)); ?>" style="color:blue;"><i class="icon-wrench"></i>修改</a>
                                <br>
                                <a class = 'rules' data= '31' href="<?php echo e(url('/admin/links/delete'.'/'.$v->id)); ?>" style="color:RED;"><i class="icon-trash"></i>删除</a>
                            </td>
