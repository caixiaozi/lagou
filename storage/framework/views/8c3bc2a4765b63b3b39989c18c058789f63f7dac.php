...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('home/shou/login/zhpass/step1.html_aio_4f347d0.css')); ?>">
        ...
        <form action="home/password/email" method="POST">
            ...
            <div class="form_body" data-view="emailFindStep1">
                <div style="display: block;" class="input_item clearfix" data-propertyname="email" data-controltype="Email">
                    <input class="input input_white"  name="email" placeholder="请输入注册时使用的邮箱地址" data-required="required" autocomplete="off" type="text" value="<?php echo e(old('email')); ?>">
                </div>
...
<script type="text/javascript" src="<?php echo e(url('home/shou/login/zhpass/vendor_c7a7c93.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('home/shou/login/zhpass/step1.html_aio_62622db.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('home/shou/login/zhpass/static_ab40326.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('home/shou/login/zhpass/zhaohui.js')); ?>"></script>
<script type="text/javascript">
    //login page
    require(['pc/page/findpassword/main']);
</script>
<script type="text/javascript" src="<?php echo e(url('home/shou/login/zhpass/oss.js')); ?>"></script></body>
</html>
