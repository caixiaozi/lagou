            ...
            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr class="odd">
                            <td class="  sorting_1"><?php echo e($permission->id); ?></td>
                            <td class=" "><?php echo e($permission->name); ?></td>
                            <td class=" "><?php echo e($permission->display_name); ?></td>
                            <td class=" "><?php echo e($permission->description); ?></td>
                            <td class=" ">
                                <a class = 'rules' data= '30' href="<?php echo e(url('admin/permission-update'.'/'.$permission->id)); ?>" style="color:blue;"><i class="icon-wrench"></i>修改</a>
                                <br>
                                <a class = 'rules' data= '31' href="<?php echo e(url('admin/permission-delete'.'/'.$permission->id)); ?>" style="color:RED;"><i class="icon-trash"></i>删除</a>
                            </td>
                        </tr>
