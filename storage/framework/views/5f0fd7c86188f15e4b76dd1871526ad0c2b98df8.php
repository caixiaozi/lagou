...
<head>
    ...
    <script charset="utf-8" src="<?php echo e(url('home/hua/css/v.js')); ?>"></script>
    <script async="" src="<?php echo e(url('home/hua/css/analytics.js')); ?>"></script>
    <script async="" src="<?php echo e(url('home/hua/css/a.js')); ?>"></script>
    ...
    <script src="<?php echo e(url('home/hua/css/jquery.validate.min_68512c2.js')); ?>" class="lazyload" charset="utf-8"></script>
    <link href="<?php echo e(url('home/hua/css/loginpop_113e5e2.css')); ?>" rel="stylesheet" class="lazyload" charset="utf-8">
    <script data-require-id="common/widgets/common/msgPopup" src="<?php echo e(url('home/hua/css/msgPopup_9611cae.js')); ?>" async=""></script>
    <script src="<?php echo e(url('home/hua/css/lagou_5427c0e.js')); ?>" class="lazyload" charset="utf-8"></script>
    <script data-require-id="common/components/template-helper/main" src="<?php echo e(url('home/hua/css/main_e08c2f2.js')); ?>" async=""></script>
</head>
...
<div class="container clearfix" id="container" style="min-height: 841px;">
    <div id="sidebar" class="sidebar">
        ...
        <div class = 'mainNavs'>
            <?php $__currentLoopData = $data['category']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <div class="menu_box">
                    <div class="menu_main job_hopping">
                        ...
                        <!-- 跳槽月 -->
                            <span></span></h2>
                        <?php $__currentLoopData = $res[$k]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thr): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <a data-lg-tj-cid="idnull" data-lg-tj-no="0011" data-lg-tj-id="4A00" href="/search?job=<?php echo e($thr); ?>"><?php echo e($thr); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    </div>
                    <div class="menu_sub dn" style="top: 0px;">
                        <?php $__currentLoopData = $v; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke => $val): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <dl>
                                <dt>
                                    <a data-lg-tj-cid="idnull" data-lg-tj-no="0001" data-lg-tj-id="4H00" href="/search?job=<?php echo e($ke); ?>">
                                        <?php echo e($ke); ?>

                                    </a></dt>
                                <dd>
                                    <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <a class="" data-lg-tj-cid="idnull" data-lg-tj-no="0121" data-lg-tj-id="4O00" href="/search?job=<?php echo e($value); ?>">
                                            <?php echo e($value); ?>
    ...
    <div class="content">
        ...
        <ul id="da-thumbs" class="da-thumbs">
            ...
            <?php $__currentLoopData = $ad; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <li>
                    <a class="" href="<?php echo e($v -> url); ?>" target="_blank" data-lg-tj-id="ey00" data-lg-tj-no="0001" data-lg-tj-cid="5307">
                        <img src="<?php echo e($v -> pic); ?>" width="111" height="113" alt="">
                        <div class="hot_info">
                            <h2 title=""></h2>
                            <em></em>
                            <p title="让你发现身边志同道合的人。"><?php echo e($v -> des); ?></p></div>
                    </a>
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
        ...
        <div class="job_list clearfix" id="jobList">
            ...
            <div  class="hot_posHotPosition position_list init_joblist"  data-lg-tj-track-code="index_hotjob" data-lg-tj-track-type="1">
                ...
                <ul class="clearfix">
                    <?php $__currentLoopData = $data['job']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    ...
                                    <div class="position_name">
                                        ...
                                        <h2 class="fl">
                                            <a data-="1841415" da-lg-tj-no="0001" data-j-id="rz00" dadex="0"
                                               class="positlink fl wordCut" target="_blank" href="/JobShow?job=<?php echo e($v -> id); ?>">
                                                <?php echo e($v -> name); ?>

                                                <span>[<?php echo e($v -> city); ?>]</span></a>

                                        </h2>
                                        <!-- 此处需要和后台确认 -->
                                        <span class="fl"><?php echo e(date('Y-m-d',$v-> modify_time)); ?></span></div>
                                    <div>
                                        <span class="salary fl"><?php echo e($v -> salary_low); ?>k-<?php echo e($v -> salary_high); ?>k</span>
                                        <span>
                        <!-- <i class="experience"></i>&nbsp;  -->经验<?php echo e($v -> work_year); ?></span>/
                                        <span><?php echo e($v -> edu); ?></span></div>
                                </div>
                                <div class="fr pli_top_r">
                                    <div class="company_name wordCut">
                                        <a data-lg-tj-cid="64001" data-lg-tj-no="0001" data-lg-tj-id="w100"
                                           target="_blank" href="/company/inser?id=<?php echo e($v -> com_id); ?>"><?php echo e($v -> com_name); ?></a></div>
                                    <div class="industry wordCut">
                                        <span><?php echo e($v -> com_trade); ?></span>/
                                        <span><?php echo e(str_replace([0,1,2,3,4,5],['不需要融资','A轮融资','B轮融资','C轮融资','D轮融资','天使轮'],$v -> com_stage)); ?></span></div>
                                </div>
                            </div>
                            <div class="pli_btm">
                                <div class="pli_btm_l fl wordCut">“<?php echo e($v -> welfare); ?>”</div>
        ...
        <div id="linkbox" class="linkbox">
            <dl>
                <dt>友情链接</dt>
                <dd>
                    <?php $__currentLoopData = $data['links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <a href="<?php echo e($v -> url); ?>" target="_blank"><?php echo e($v ->name); ?></a>
                        <span>|</span>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                </dd>
    ...
    <div class="wrapper">
        ...
        <div class="inner_wrapper">
            <a class="footer_app" href="#/app/download.html" rel="nofollow">拉勾APP
                <span>new</span>
                <img data-delay-src="#/image2/M00/24/1D/CgqLKVaLdtWAKVC3AAEEpK9-Koc598.JPG" width="256" height="256" src="<?php echo e(url('home/shou/css/Cgp3O1h0u3yAHBOLAAEEpK9-Koc621.jpg')); ?>"></a>
...
<script type="text/javascript" src="<?php echo e(url('home/hua/css/vendor_8eb7ff4.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(url('home/hua/css/main.html_aio_44fc3d9.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('home/hua/css/widgets_eb7c7db.js')); ?>"></script>
<script src="<?php echo e(url('home/hua/css/h.js')); ?>" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo e(url('home/hua/css/userinfo_7f282e9.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('home/hua/css/layout_8f98554.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('home/hua/css/main.html_aio_2_d9035e3.js')); ?>"></script>
