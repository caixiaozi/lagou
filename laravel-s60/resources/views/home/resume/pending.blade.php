...
@section('content')
    <link rel="stylesheet" href="{{url('home/resume/css/index.css')}}"/>
                                    ...
                                    <form action="/resume/email" method="post" id="editForm">
                                        <ul class="editInfos">
                                            ...
                                            <li><label><font color="#ff0000">* </font>面试时间
                                                    <input style="font-size:13px; width:360px" type="text" name="audition_time" required value="{{date('Y-m-d H:i',time())}}" class="ipt" /></label></li>
