...
<head>
    ...
    <link href="{{url('home/shou/login/zcyxyz/header.css')}}" rel="stylesheet" />
    <link href="{{url('home/shou/login/zcyxyz/style.css')}}" type="text/css" rel="stylesheet" />
    <link href="{{url('home/shou/login/zcyxyz/external.min.css')}}" type="text/css" rel="stylesheet" />
    <link href="{{url('home/shou/login/zcyxyz/popup.css')}}" type="text/css" rel="stylesheet" />
    <script type="text/javascript" src="{{url('home/shou/login/zcyxyz/jquery.1.10.1.min.js')}}"></script>
    <script src="{{url('home/shou/login/zcyxyz/jquery.lib.min.js')}}" type="text/javascript"></script>
    <script type="text/javascript" src="{{url('home/shou/login/zcyxyz/ajaxfileupload.js')}}"></script>
    <script src="{{url('home/shou/login/zcyxyz/additional-methods.js')}}" type="text/javascript"></script>
    <script type="text/javascript" async="" src="{{url('home/shou/login/zcyxyz/conversion.js')}}"></script>
    <script src="{{url('home/shou/login/zcyxyz/allmobilize.min.js')}}" charset="utf-8" id="allmobilize"></script>
    <script src="{{url('home/shou/login/zcyxyz/conv.js')}}" type="text/javascript"></script>
    <!--[if lte IE 8]>
    <script type="text/javascript" src="{{url('home/shou/login/zcyxyz/excanvas.js')}}"></script>
    <![endif]-->
    <script type="text/javascript">
