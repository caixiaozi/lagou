                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    @foreach($users as $user)
                        <tr class="odd">
                            ...
                            <td >{{$user->roles}}</td>
                            <td >
                                <a class = 'rules' data= '30' href="{{url('admin/attach-role'.'/'.$user->id)}}" style="color:blue;"><i class="icon-wrench"></i>分配角色</a>
                                <br>
                                <a class = 'rules' data= '31' href="{{url('admin/user-delete'.'/'.$user->id)}}" style="color:RED;"><i class="icon-trash"></i>删除</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
