                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
                    ...
                    @foreach($roles as $role)
                        <tr class="odd">
                            ...
                            <td>{{$role->perms}}</td>
                            <td class=" ">
                                <a class = 'rules' data= '30' href="{{url('admin/attach-permission'.'/'.$role->id)}}" style="color:blue;">分配权限</a>
                                <br>
                                <a class = 'rules' data= '30' href="{{url('admin/role-update'.'/'.$role->id)}}" style="color:blue;"><i class="icon-wrench"></i>修改</a>
                                <br>
                                <a class = 'rules' data= '31' href="{{url('admin/role-delete'.'/'.$role->id)}}" style="color:RED;"><i class="icon-trash"></i>删除</a>
                            </td>
