...
<head>
    ...
    <meta content="搜股,搜股招聘,搜股最新招聘信息,搜股（北京）科技有限公司,搜股（北京）科技有限公司职位招聘" name="keywords">
...
<div id="lg_header">
    ...
    <div id="lg_tbar">
        <div class="inner">
            <div class="lg_tbar_l">
                <a class="lg_app" data-lg-tj-id="5500" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" target="_blank">拉勾APP</a>
                <a rel="nofollow" class="lg_os" data-lg-tj-id="5600" data-lg-tj-no="idnull" data-lg-tj-cid="idnull">进入企业版</a>
            </div>
            <ul class="lg_tbar_r">
                <!-- if has unread message, add class unreaded -->
                <li class="msg_dropdown"> <a class="msg_group" href="javascript:%20void%200;" data-lg-tj-id="5h00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow"> 消息 <em class="msg_amount hide" id="headMsgAmount"></em> </a>
                    <div class="lg_msg_popup">
                        <div style="overflow: hidden;" class="lg_msg_pu_body mCustomScrollbar _mCS_3" id="lgPopupMsgBody">
                            <div class="mCustomScrollBox mCS-dark-2" id="mCSB_3" style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 250px;">
                        ...
                        <div class="lg_msg_pu_footer">
                            <a href="" target="_blank" class="lg_msg_setting fl"><i class="lg_msg_avatar setting_i"></i>&nbsp;</a>
                            <a href="" class="lg_msg_more fr">查看更多</a>
                        </div>
                    </div> </li>
                <li> <a href="" class="bl" data-lg-tj-id="5700" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">我的简历</a> </li>
                <li> <a href="" class="bl" id="deliveryLink" data-lg-tj-id="5800" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">投递箱</a> <em class="noticeDot dn" id="noticeDot_delivery"></em> </li>
                <li> <a href="" class="bl" data-lg-tj-id="5900" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">收藏夹</a> </li>
                <li class="user_dpdown"> <span class="unick bl">杜玉玲</span> <em class="noticeDot dn" id="noticeDot_name"></em> <i></i>
                    <ul>
                        <li> <a href="" data-lg-tj-id="5a00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">我的订阅</a> </li>
                        <li> <a href="" id="invitationLink" data-lg-tj-id="5b00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow" data-lg-gatj-msg="header_c,职位邀请,number">职位邀请</a> <em class="noticeDot dn" id="noticeDot_invitation"></em> </li>
                        <li> <a href="" data-lg-tj-id="5c00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">帐号设置</a> </li>
                        <li> <a href="" data-lg-tj-id="5d00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">去企业版</a> </li>
                        <li> <a href="/login/logout" data-lg-tj-id="5e00" data-lg-tj-no="idnull" data-lg-tj-cid="idnull" rel="nofollow">退出</a> </li>
                    </ul> </li>
            </ul>
        </div>
    </div>
...
<!-- 公司详情页、职位详情页 推荐-->
    <div class="popular_recom hide-recom">
        <a rel="nofollow" href="javascript:;" class="expansion"><i></i></a>
    ...
    <div class="navigator_container">
        <div class="nav_item nav_selected" data-name="#company_products">
            <div class="nav_item_icon_wrap">
                <em class="nav_item_icon"></em>
            </div>
            <div class="nav_item_icon_wrap">
                <em class="nav_item_icon_up"></em>
            </div>
...
<div id="feedback-con">
    ...
    <form id="product-fb">
        <div class="pfb-txt">
            ...
            <div class="pfb-input-tip" id="pfbInputTip">
                0/200
            </div>
        </div>
        ...
        <div class="connect-gou-mei">
            <a id="popOnlineService" href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&amp;key=XzgwMDA1NjM3OV80MTk5NzZfODAwMDU2Mzc5XzJf" target="_blank" rel="nofollow">与勾妹谈谈人生</a>
        </div>
    </form>
</div>
<div id="footer">
...
<script type="text/javascript" src="{{url('home/gong/js/vendor_8eb7ff4.js')}}"></script>
<script type="text/javascript">/*resourcemap*/
    require.config({paths:{
        "common/components/template-helper/main": "http://www.lgstatic.com/www/static/common/components/template-helper/main_e08c2f2",
        "common/widgets/common/msgPopup": "http://www.lgstatic.com/www/static/common/widgets/common/msgPopup_e0a866f"
    }});</script>
<script type="text/javascript" src="{{url('home/gong/js/main.js')}}"></script>
<script type="text/javascript" src="{{url('home/gong/js/widgets_87e406a.js')}}"></script>
<script src="{{url('home/gong/js/h.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{url('home/gong/js/userinfo_7f282e9.js')}}"></script>
<script type="text/javascript" src="{{url('home/gong/js/layout_8f98554.js')}}"></script>
<script type="text/javascript" src="{{url('home/gong/js/main_002.js')}}"></script>
<script type="text/javascript">
    ...
    global.comprehensiveScore = "3.7";
    global.describeScore =  "5.0";
    global.interviewerScore =  "5.0";
    global.companyScore =  "4.5";
    ...
    require(['company-c/modules/questions/main']);
...
<div class="support_list_popup_wrap" id="supportListPopupWrap">
    <div class="support_list_popup_box" id="supportListPopupBox">
        <div class="support_list">
            <ul></ul>
        </div>
    </div>
</div>
<script src="{{url('home/gong/js/static.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{url('home/gong/js/oss.js')}}"></script>
...
<script src="{{url('home/gong/js/api.js')}}" type="text/javascript"></script>
<script src="{{url('home/gong/js/getscript.js')}}"></script>
<div style="position: absolute; z-index: 100000; top: 282.25px; left: 732.5px; visibility: visible; display: block;" class="tipsy tipsy-north"></div>
</body>
</html>