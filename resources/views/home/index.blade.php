    ...
    <div class="content">
        ...
        <div id="home_banner" class="home_banner" data-lg-tj-track-code="index_bannerad" data-lg-tj-track-type="1">
            <ul class="banner_bg">
                @foreach($arr1 as $arr)
                    <li class="banner_bg_1 current">
                        <a href="{{asset($arr->url)}}" target="_blank" class="tj_exposure" rel="nofollow" data-lg-tj-id="et00" data-lg-tj-no="0001" data-lg-tj-cid="3355"><img
                                    src="{{asset('admin/image/carousel/'.$arr->pic)}}" width="612" height="160"
                                    alt="{{$arr->descr}}"/></a>
                    </li>
                @endforeach
            </ul>
            <div class="banner_control">
                ...
                <ul class="thumbs">
                    @foreach($arr1 as $arr)
                        <li class="thumbs_{{$loop->iteration}}">
                            <i></i>
                            <img src="{{asset('admin/image/carousel/'.$arr->pic)}}" width="113" height="42"/>
                        </li>
                    @endforeach
