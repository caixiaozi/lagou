...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('home/shou/login/register/main.html_aio_52836d2.css')}}">
...
<script type="text/javascript" src="{{url('home/shou/login/register/vendor_c7a7c93.js')}}"></script>
<script type="text/javascript" src="{{url('home/shou/login/register/main.html_aio_e995440.js')}}"></script>
<script type="text/javascript" src="{{url('home/shou/login/register/static_ab40326.js')}}"></script>
...
<script type="text/javascript" src="{{url('home/shou/login/register/oss.js')}}"></script>
</body>
</html>
