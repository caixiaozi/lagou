...
<<<<<<< HEAD
                ...
                <dd class="job_bt">
                    ...
                    1、依据产品需求完成高质量的PC、移动前端开发和维护；

                    2、对具体的产品UI、UE要求进行前端性能优化，确保产品具有一流的用户体验；

                    3、在理解前端开发流程的基础上，结合前端实际建立或优化提升工作效率的工具；

                    4、了解产品后端技术实现，提供对应的前端解决方案，并配合后端工程师完成开发和调试；

                    5、参与制定公司前端框架的优化并负责产品性能和代码优化的实施。
                    <br>
                    <br>
                    ...
                    1、一年以上工作经验，有大中型前端开发经验者优先；

                    2、精通HTML5、JavaScript、CSS3等前端技术、有独立开发高质量PC、移动前端的能力.

                    3、深刻理解 Web 标准、HTML 语言化标签，对符合 Web 标准的网站重构有丰富经验；

                    4、熟练并掌握Ajax、JSON、jQuery等技术；

                    5、熟悉常用前端框架或类库，知道如何选择最为合适的框架或类库进行高效的开发。
                    <p><br></p>
                </dd>
                ...
                <dd class="jd_deliver clearfix">
                    <a rel="nofollow" href="/JobShow/resumesend" title="登录" class="passport_login_pop btn fr btn_apply" onclick=""></a>
                </dd>
            </dl>
...
-->
        ...
        <div class="content_r">
            <dl class="job_company">
                <dt>
                    <a href="/company/insert}" target="_blank">
                        <img class="b2" src="{{url('home/jobShow/index/images/meiyou.png')}}" alt="厦门美柚信息科技有限公司招聘信息" height="80" width="80">
                        <div>
                            <h2 class="fl">
                                美柚
                                <img src="{{url('home/jobShow/index/images/chanping.png')}}" alt="拉勾认证企业" height="19" width="15">
                ...
                <dd>
                    <ul class="c_feature">
                        ...
                        <li>
                            <span>规模</span> 500-2000人
                        </li>
                        <li>
                            <span>主页</span>
                            <a href="#/" target="_blank" title="#" rel="nofollow">http://www.xixiaoyou.com/</a>
                        </li>
                    </ul>
                    <h4>发展阶段</h4>
                    <ul class="c_feature">
                        <li><span>目前阶段</span> 获得D轮及以上融资</li>
                    </ul>

                    <h4>工作地址</h4>
                    <div class="work_addr">
                        <a href="#/jobs/list_?city=%E5%85%A8%E5%9B%BD#filterBox"></a>
                        杭州余杭区文一西路1288号海创科技中心3号楼12楼
                    </div>
